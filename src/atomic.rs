// SPDX-FileCopyrightText: Copyright (c) 2014-2022 by various Rust contributors
// SPDX-FileCopyrightText: Copyright (c) 2022 by Rivos Inc.
// Dual-licensed under the Apache License, Version 2.0, and MIT license, see
// LICENSE-APACHE and LICENSE-MIT for details.
// SPDX-License-Identifier: Apache-2.0
// SPDX-License-Identifier: MIT
//
// Most of the code in this file is originally from commit 
// 4982a59986f7393ace98f63c10e6c435ffba1420 of rust-lang/rust.
// (https://github.com/rust-lang/rust), which is dual-licensed under both MIT
// and Apache 2.0.
...
#![cfg_attr(not(feature = "atomic_8"), allow(dead_code))]
#![cfg_attr(not(feature = "atomic_8"), allow(unused_imports))]
...
cfg_if::cfg_if! {
    if #[cfg(not(feature = "user-mode"))] {
        use riscv::register::mstatus;

        unsafe fn disable_mie() -> bool
        {
            if mstatus::read().mie() {
                mstatus::clear_mie();
                return true;
        ...
        unsafe fn restore_mie(state: bool)
        {
            if state == true {
                mstatus::set_mie();
            }
        ...
        unsafe fn restore_mie(_state: bool)
        {
            return;
        }
    }
...
macro_rules! atomic_int {
    ($cfg_cas:meta,
     ...
     $int_type:ident $atomic_type:ident $atomic_init:ident) => {
        ...
        /// `].
        ///
        /// [module-level documentation]: core::sync::atomic
        #[repr(C, align($align))]
...
#[inline]
unsafe fn atomic_store<T: Copy>(dst: *mut T, val: T, _order: Ordering) {
    /*
    ...
    */
    let mie: bool = disable_mie();
    *dst = val;
    restore_mie(mie);
}

#[inline]
unsafe fn atomic_load<T: Copy>(dst: *const T, _order: Ordering) -> T {
    /*
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_swap<T: Copy>(dst: *mut T, val: T, _order: Ordering) -> T {
    /*
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_add<T: Copy + ops::Add + ops::Add<Output = T>>(
    dst: *mut T,
    val: T,
    _order: Ordering,
) -> T {
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_sub<T: Copy + ops::Sub + ops::Sub<Output = T>>(
    dst: *mut T,
    val: T,
    _order: Ordering,
) -> T {
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_compare_exchange<T: Copy + cmp::PartialEq>(
    dst: *mut T,
    old: T,
    new: T,
    _success: Ordering,
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_compare_exchange_weak<T: Copy + cmp::PartialEq>(
    dst: *mut T,
    old: T,
    new: T,
    success: Ordering,
    ...
    */
    return atomic_compare_exchange(dst, old, new, success, failure);
}

#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_and<T: Copy + ops::BitAnd + ops::BitAnd<Output = T>>(
    dst: *mut T,
    val: T,
    _order: Ordering,
) -> T {
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_nand<
    T: Copy + ops::BitAnd + ops::BitAnd<Output = T> + ops::Not + ops::Not<Output = T>,
>(
    dst: *mut T,
    val: T,
    _order: Ordering,
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_or<T: Copy + ops::BitOr + ops::BitOr<Output = T>>(
    dst: *mut T,
    val: T,
    _order: Ordering,
) -> T {
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_xor<T: Copy + ops::BitXor + ops::BitXor<Output = T>>(
    dst: *mut T,
    val: T,
    _order: Ordering,
) -> T {
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_max<T: Copy + cmp::PartialOrd>(dst: *mut T, val: T, _order: Ordering) -> T {
    /*
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_min<T: Copy + cmp::PartialOrd>(dst: *mut T, val: T, _order: Ordering) -> T {
    /*
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_umax<T: Copy + cmp::PartialOrd>(dst: *mut T, val: T, _order: Ordering) -> T {
    /*
...
#[inline]
#[cfg(feature = "atomic_8")]
unsafe fn atomic_umin<T: Copy + cmp::PartialOrd>(dst: *mut T, val: T, _order: Ordering) -> T {
    /*
...
///
/// [`hint::spin_loop`]: core::hint::spin_loop
#[inline]
